...
export default function ForgotPasswordForm() {
  ...
  return (
    ...
    >
      ...
      {step === 'reset' && (
        <>
          <div className="mb-5 p-4 bg-green-50 border border-green-200 rounded-xl text-sm text-green-800 flex items-start" role="status" aria-live="polite">
            <svg className="w-5 h-5 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
      ...
      {successMessage && step === 'reset' && (
        <div 
          role="alert"
          aria-live="polite"
          className="mt-4 p-4 bg-green-50 border border-green-200 rounded-xl text-sm text-green-800 flex items-start"
        >
