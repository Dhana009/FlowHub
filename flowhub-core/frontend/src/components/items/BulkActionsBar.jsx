    ...
    >
      <div className="bg-slate-900 text-white rounded-full shadow-2xl px-6 py-3 flex items-center space-x-6 border border-slate-700/50 backdrop-blur-md bg-opacity-95">
        <div className="flex items-center space-x-2 border-r border-slate-700 pr-6 mr-2">
          <span className="bg-indigo-500 text-white text-xs font-bold rounded-full w-6 h-6 flex items-center justify-center" data-testid="selected-count-badge">
            {selectedCount}
          </span>
        ...
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            className="text-sm font-medium text-slate-500 hover:text-slate-300 transition-colors duration-150 ml-2"
